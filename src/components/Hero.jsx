        ...
        <section id="home" className="min-h-screen flex flex-col justify-center items-center px-6 text-center relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="max-w-5xl relative z-10 flex flex-col items-center">
                ...
                >
                    ...
                    <motion.div
                        style={{ x: x3, y: y3 }}
                        className="absolute -inset-6 border border-neon-violet/30 rounded-full animate-orbit pointer-events-none"
                    />
                    <motion.div
                        style={{ animationDirection: 'reverse', animationDuration: '30s', x: x2, y: y2 }}
                        className="absolute -inset-10 border border-neon-cyan/20 rounded-full animate-orbit pointer-events-none opacity-40"
                    />
                </motion.div>
            ...
            {/* Scroll Indicator */}
            <motion.div
                className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 text-space-950/20 dark:text-white/20"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
